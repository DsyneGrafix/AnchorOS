...
from apps.customer_onboarding_demo.security_adapter import (
    DemonstrationSecurityCore,
)
...
class CustomerPipelineTestCase(unittest.TestCase):
    def build_engine(
        ...
        *,
        ...
        security_core = DemonstrationSecurityCore(
            operational=security_operational
        )
