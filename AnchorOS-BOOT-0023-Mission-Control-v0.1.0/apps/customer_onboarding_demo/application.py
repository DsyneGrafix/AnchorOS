...
class CustomerOnboardingDemo:
    """Wire the pipeline to real Platform Services and Security Core."""
    ...
    def __init__(self) -> None:
        ...
        self.security_core = SecurityCore.from_registry(self.registry)
        self.registry.register(self.security_core)
        self.manifest.register_service(self.security_core.name)
        self.security_core.start()
